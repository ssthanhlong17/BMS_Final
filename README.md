...
### Vấn đề: SOC không khởi tạo
**Giải pháp**: 
- Kiểm tra điện áp pack > 10V
- Xem Serial log: "🔋 Init: ..."

### Vấn đề: Protection kích hoạt liên tục
**Giải pháp**:
```
Serial: clear
```
- Kiểm tra nguyên nhân (OV/UV/OC/OT)
- Chờ recovery timer (5s)

### Vấn đề: Balancing không hoạt động
**Kiểm tra**:
- Delta V > 100mV?
- Cell max ≥ 3.5V?
- Current < 0.1A (idle)?

### Vấn đề: Web không kết nối
**Giải pháp**:
- Kiểm tra WiFi: SSID `ESP32_BMS`
- Ping: `192.168.4.1`
- Khởi động lại ESP32
...
- **Hoàng Văn Quang** (B21DCVT363)
- **Phạm Thành Long** (B21DCVT275)

**Giáo viên hướng dẫn**: PGS TS Nguyễn Chiến Trinh
